...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        ...
        # Compare the pet label and classifier label to determine if they match
        match = 1 if pet_label in classifier_label else 0
        
        # Add the classifier label and match to the results dictionary using the extend function
